...
export default function Projects() {
  const projects = [
    ...
    },
    {
      ...
      desc: 'Modern personal portfolio website to showcase projects and skills.',
    ...
    {
      name: 'Booking App',
      desc: 'Mobile booking application for hotels, flights, and services.',
      tech: ['Flutter', 'Firebase'],
      image: 'https://via.placeholder.com/400x250.png?text=Booking+App',
      live: '#',
      github: '#',
      server: '#',
    },
    {
      ...
      desc: 'Corporate website with services, team, and contact sections.',
      tech: ['ASP.NET', 'SQL Server'],
      image: 'https://via.placeholder.com/400x250.png?text=Company+Website',
      live: '#',
      github: '#',
      server: '#',
    },
